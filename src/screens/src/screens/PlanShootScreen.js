...
export default function PlanShootScreen() {
  ...
  // When you run everything on your VM, backend will be at this URL
  ...
  const getLocationAndLoad = async () => {
    try {
      ...
      console.error(err);
      setErrorMsg("Failed to load conditions");
    ...
    <ScrollView contentContainerStyle={{ padding: 16 }}>
      ...
      {conditions && (
        <View style={{ marginTop: 16 }}>
          ...
          <Text>
            • Evening golden hour: stronger contrast – try silhouettes or backlit shots.
          </Text>
          <Text>
